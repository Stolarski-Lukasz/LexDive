...
class SamplingProcessor(ABC):
    ...
    @abstractclassmethod
    def sample_text(self, user_text_split):
        pass
...
class SplitTextSamplingProcessor(SamplingProcessor):
    ...
    def sample_text(self, user_text_split):
        ...
        intended_text = list(compress(user_text_split, criteria))
...
class EqualTextSamplingProcessor(SamplingProcessor):
    ...
    def sample_text(self, user_text_split):
        equal_text = user_text_split[self.equal_text_beginning-1:self.equal_text_length+(self.equal_text_beginning-1)]
