import {
  ...
  export function guirauds_r_whole_text() {
    ...
    xhr.onreadystatechange = function (e) {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        let guirauds_r_value = response_object.guirauds_r_value;
        let number_of_tokens = response_object.number_of_tokens;
        let number_of_types = response_object.number_of_types;
        ...
        create_element({ tag: "h4", innerText: "The value of Guiraud's R in the whole text: " + guirauds_r_value, parent_id: "ld_results_parent" });
        ...
        create_element({ tag: "p", style_margin: "1px", innerText: "The number of word types in the whole text: " + number_of_types, parent_id: "ld_results_parent" });
    ...
    xhr.open('POST', '/count_guirauds_r_whole_text/', true);
  ...
  export function guirauds_r_split_text() {
    ...
    if (sample_length_value > user_text.value.split(" ").length) {
      ...
      xhr.onreadystatechange = function (e) {
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          create_element({ tag: "div", className: "col-10 text-left", id: "ld_results_parent", parent_id: "ld_results_grandparent" });
          create_element({ tag: "h4", innerText: "The value of Guiraud's R in the generated sample: " + guirauds_r_value, parent_id: "ld_results_parent" });
          create_separator("ld_results_parent");
          ...
          create_element({ tag: "p", style_margin: "1px", innerText: "The number of word types in the generated sample is: " + number_of_types, parent_id: "ld_results_parent" });
      ...
      xhr.open('POST', '/count_guirauds_r_split_text/', true);
      xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
      var data = "user_text=" + user_text_without_punctuation +
  ...
  export function guirauds_r_equal_text() {
    ...
    if (sample_length_value > user_text.value.split(" ").length) {
      ...
      xhr.onreadystatechange = function (e) {
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          create_element({ tag: "p", style_margin: "1px", innerText: "The number of word types in the generated sample: " + number_of_types, parent_id: "ld_results_parent" });
      ...
      xhr.open('POST', '/count_guirauds_r_equal_text/', true);
      xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
      var data = "user_text=" + user_text_without_punctuation +
