...
export function ttr_whole_text() {
  ...
  xhr.onreadystatechange = function (e) {
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      create_element({ tag: "h4", innerText: "The value of TTR (Type Token Ratio) in the whole text: " + ttr_value, parent_id: "ld_results_parent" });
  ...
  xhr.open('POST', '/count_ttr_whole_text/', true);
...
export function ttr_split_text() {
  ...
  if (sample_length_value > user_text.value.split(" ").length) {
    ...
    xhr.onreadystatechange = function (e) {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        create_element({ tag: "div", className: "col-10 text-left", id: "ld_results_parent", parent_id: "ld_results_grandparent" });
        create_element({ tag: "h4", innerText: "The value of TTR (Type Token Ratio) in the generated sample: " + ttr_value, parent_id: "ld_results_parent" });
        create_separator("ld_results_parent");
    ...
    xhr.open('POST', '/count_ttr_split_text/', true);
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
    var data = "user_text=" + user_text_without_punctuation +
...
export function ttr_equal_text() {
  ...
  if (sample_length_value > user_text.value.split(" ").length) {
    ...
    xhr.open('POST', '/count_ttr_equal_text/', true);
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
    var data = "user_text=" + user_text_without_punctuation +
