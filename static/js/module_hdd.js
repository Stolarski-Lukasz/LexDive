...
export function hdd_whole_text() {
  ...
  xhr.onreadystatechange = function (e) {
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      create_element({ tag: "h4", innerText: "The value of HDD (Hypergeometric distribution D) in the whole text: " + hdd_value, parent_id: "ld_results_parent" });
  ...
  xhr.open('POST', '/count_hdd_whole_text/', true);
