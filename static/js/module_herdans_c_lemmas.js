import {
  ...
  export function herdans_c_whole_text_lemmas() {
    ...
    xhr.onreadystatechange = function (e) {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        create_element({ tag: "h4", innerText: "The value of Herdan's C (with lemmas instead of types) in the whole text: " + herdans_c_value, parent_id: "ld_results_parent" });
    ...
    xhr.open('POST', '/count_herdans_c_whole_text_lemmas/', true);
  ...
  export function herdans_c_split_text_lemmas() {
    ...
    if (sample_length_value > user_text.value.split(" ").length) {
      ...
      xhr.onreadystatechange = function (e) {
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          create_element({ tag: "div", className: "col-10 text-left", id: "ld_results_parent", parent_id: "ld_results_grandparent" });
          create_element({ tag: "h4", innerText: "The value of Herdan's C (with lemmas instead of types) in the generated sample: " + herdans_c_value, parent_id: "ld_results_parent" });
          create_separator("ld_results_parent");
      ...
      xhr.open('POST', '/count_herdans_c_split_text_lemmas/', true);
      xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
      var data = "user_text=" + user_text_without_punctuation +
  ...
  export function herdans_c_equal_text_lemmas() {
    ...
    if (sample_length_value > user_text.value.split(" ").length) {
      ...
      xhr.open('POST', '/count_herdans_c_equal_text_lemmas/', true);
      xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
      var data = "user_text=" + user_text_without_punctuation +
